  ...
  void dependencies() {
    switch (Get.arguments as String) {
      case 'bookmark':
        ...
        break;
      case 'artist':
        Get.lazyPut(() => WaterFlowController(model: 'artist', isManga: false),
            tag: 'artist_false');
        Get.lazyPut(() => WaterFlowController(model: 'artist', isManga: true),
            tag: 'artist_true');
        break;
      case 'history':
        Get.lazyPut(() => WaterFlowController(model: 'history'),
            tag: 'history');
        Get.lazyPut(
            () => WaterFlowController(model: 'oldHistory', isManga: true),
            tag: 'oldHistory');
        break;
    }
  }
